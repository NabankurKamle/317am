        ...
        <table width="100%" style="max-width:560px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:20px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:32px 36px 24px;border-bottom:1px solid rgba(255,255,255,0.06);">
              <p style="margin:0;color:rgba(255,255,255,0.3);font-size:11px;letter-spacing:0.35em;text-transform:uppercase;">
                3:17 AM
              </p>
              <h1 style="margin:8px 0 0;color:rgba(245,243,255,0.85);font-size:26px;font-weight:400;line-height:1.2;">
                ${title}
              </h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 36px 32px;">
              <a href="${ctaUrl}"
                style="display:inline-block;padding:14px 28px;background:rgba(139,92,246,0.2);
                       border:1px solid rgba(139,92,246,0.5);border-radius:12px;
                       color:#A78BFA;text-decoration:none;font-size:14px;
          ...
          <tr>
            <td style="padding:20px 36px;border-top:1px solid rgba(255,255,255,0.05);">
              <p style="margin:0;color:rgba(255,255,255,0.2);font-size:11px;line-height:1.6;">
                ...
                <a href="${ENV.CLIENT_URL}" style="color:rgba(139,92,246,0.6);text-decoration:none;">
                  Visit your archive
                </a>
              </p>
            </td>
...
export const sendCapsuleUnlockEmail = async ({ to, username, capsuleTitle, capsuleContent, capsuleId }) => {
    // Truncate preview — full content is in the app
    ...
    const html = baseTemplate({
      ...
      <div style="background:rgba(125,211,252,0.06);border:1px solid rgba(125,211,252,0.2);
                  border-radius:14px;padding:20px 24px;margin-bottom:24px;">
        <p style="margin:0 0 8px;color:rgba(125,211,252,0.7);font-size:11px;
                  letter-spacing:0.3em;text-transform:uppercase;">
          ⟁ Unsealed
        </p>
        <p style="margin:0 0 12px;color:rgba(245,243,255,0.8);font-size:18px;font-weight:400;">
          ${capsuleTitle || 'Unnamed Capsule'}
        </p>
        <p style="margin:0;color:rgba(245,243,255,0.45);font-size:14px;line-height:1.7;
                  font-style:italic;">
          "${preview}"
        </p>
      </div>
      <p style="margin:0 0 8px;color:rgba(245,243,255,0.35);font-size:13px;line-height:1.6;">
        Open your archive to read the full message.
      </p>
    `,
    ...
    return transporter.sendMail({
        ...
        html,
        text: `Hey ${username}, your time capsule "${capsuleTitle}" has opened. Visit ${ENV.CLIENT_URL}/capsules to read it.`,
    });
};
...
export const sendWelcomeEmail = async ({ to, username }) => {
    const html = baseTemplate({
        ...
        body: `
      <p style="margin:0 0 16px;color:rgba(245,243,255,0.6);font-size:15px;line-height:1.7;">
        Your midnight archive is ready.
      </p>
      <p style="margin:0 0 24px;color:rgba(245,243,255,0.6);font-size:15px;line-height:1.7;">
        Leave fragments. Write echoes. Seal time capsules. Log how the night feels.
        Everything is waiting for you.
      </p>
      <p style="margin:0;color:rgba(245,243,255,0.3);font-size:13px;line-height:1.6;">
    ...
    return transporter.sendMail({
        ...
        html,
        text: `Welcome to 3:17 AM, ${username}. Your midnight archive is ready. Visit ${ENV.CLIENT_URL}/tonight`,
    });
};